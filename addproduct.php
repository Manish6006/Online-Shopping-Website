...
<script>tinymce.init({selector:'textarea'});</script>
    ...
    <body  style="background: url('pics/Mens-Fashion-Style.jpg');background-position:top center;background-repeat: no-repeat;background-size: 100%">
        <div id='loginscreen' class="flipInY animated col-sm-4 col-sm-offset-4" style="opacity:0.9;box-shadow:0px 0px 10px black;border-radius:10px;background-color:#0a2948;padding:0px;margin-top:1%;">
            <h1 style="text-shadow:1px 1px black;border-top-left-radius:10px;border-top-right-radius: 10px;margin: 0px;background-color: #3b90e1;text-align: center;color:white;padding:10px 0px;box-shadow:0px 10px 10px -10px black;">NEW USER</h1>
            <div style="padding: 30px">
                <form action="finalproduct.php" method="post" name='f1' enctype="multipart/form-data">
                <input style="margin-bottom: 3px;" placeholder="User Namae" type="text" name="vuser" class="form-control">
                ...
                <input style="margin-bottom: 3px;" placeholder="Contact" type="text" name="contact" class="form-control">
                 <input style="margin-bottom: 3px;" placeholder="Product id" type="text" name="id" class="form-control">
                ...
                <textarea style="margin-bottom: 3px;"   cols="20" rows="10" name="pdetail" class="form-control">enter details</textarea>
             <!-- <p>upload a file:<input type="file" name="fileupload"></p><br>-->
            
             <p>upload a file:<input type="file" name="img"></p><br>
